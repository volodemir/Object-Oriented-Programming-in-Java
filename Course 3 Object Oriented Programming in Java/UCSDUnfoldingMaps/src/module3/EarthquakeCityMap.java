...
public class EarthquakeCityMap extends PApplet {
	...
	public void setup() {
		...
		if (offline) {
			...
			map = new UnfoldingMap(this, 200, 50, 700, 500, new ThunderforestProvider.Landscape());
	...
	{  
		...
		List<SimplePointMarker> markerList = new ArrayList<SimplePointMarker>();
	    ...
	    for (SimplePointMarker mk: markerList) {
