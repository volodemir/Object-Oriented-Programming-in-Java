...
public class EarthquakeCityMap extends PApplet {
	...
	private void addKey() {	
		...
		fill(color(255, 0, 0));
		triangle(50, 115, 55, 104, 59, 115);
		
		fill(color(255, 255, 255));
		ellipse(55, 132, 12, 12);
		...
		fill(color(255,255,0));
		ellipse(58, 211, 10, 10);
		
		fill(color(0, 0, 255));
		ellipse(58, 233, 10, 10);
		
		fill(color(255,0,0));
		ellipse(58, 255, 10, 10);
		
		fill(0, 0, 0);
		text("City Marker", 75, 108);
		text("Land Quake", 75, 130);
		text("Ocean Quake", 75, 152);
		text("Size ~ Magnitude", 50, 174);
		text("Shallow", 75, 209);
		text("Intermediate", 75, 231);
		text("Deep", 75, 253);
	}
